...
<h1>Monitoramento(Inspeção Final)</h1>
    ...
    <?php include("config/tabela_monitoramento_inspf/tabela.php")?>
<br><br>
            ...
            <tbody>
                <?php 
                    while($dados = mysqli_fetch_assoc($sql)){
                        ...
                        echo "<td>
                        <a class = 'btn btn-primary' href='edit_tabela_monitoramento.php?id=$dados[ID_OP]'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'tabela_monitoramento.php?search='+search.value;
    }
</script>
</html>